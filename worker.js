...
const BOT_TOKEN = "7556995516:AAH7owjCJ2FYzTSdKX6-ZyOI1O5JmmqoJQI"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "7357297900"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 2052400282; // Insert your telegram account id.
const BOT_CHANNEL = -1003143688977; // Insert your telegram channel id which the bot is admin in.
const SIA_SECRET = "7357297900"; // Insert a powerful secret text and keep it safe.
